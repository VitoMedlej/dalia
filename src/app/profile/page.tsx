     ...
     <Grid container >
            {
                ...
                <Typography sx={{py:4,fontSize:'1.5em',fontWeight:'600'}}>
                    User Details
                </Typography>
                <Box>
        ...
        :
          <Box sx={{py:8,mx:1}} className='flex center auto col' >
        ...
        sx={{margin:'.75em auto',width:'120px'}}>Login</Btn>
           ...
           {localUser && <Grid sx={{py:8}} className='auto' xs={12} sm={4} md={8.9}>
                ...
                <Typography
                 sx={{textAlign:'center',mb:0,fontSize:'1.5em',fontWeight:'600'}}>
...

                    {
                        ...
                        <Btn className=''
                        sx={{mt:1,mx:'auto',p:' .25em .75em !Important'}}
