...
const text = [
    ...
    `At True Nature Blend, excellence is not just a goal; it's our way of life. We are committed to providing you with products that are not only effective but also safe. Our team of experts works tirelessly to source the purest and most potent ingredients from nature's bounty.`,
    `We believe that when you choose True Nature Blend, you're choosing a partner on your path to a healthier and more vibrant life.`,
  ...
  return (
    <Container maxWidth='lg' className='auto' sx={{mx:1,py:4}}>
        ...
        <Box sx={{width:'100%',height:'400px'}}>
            <img src="https://ucarecdn.com/42db8a52-041f-4b79-8bfb-5c10a3a3c4fd/truenatureblendgreen011.jpg" alt="" className="img contain" />
        </Box>
