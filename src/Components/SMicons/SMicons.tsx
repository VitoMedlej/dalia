...
const sm = [
    ...
    {Icon:'https://cdn-icons-png.flaticon.com/128/1384/1384023.png',href:'https://wa.me/+96171521926'},
...
const SMicons = ({sx,color}:{color?:string,sx?:any}) => {
  return (
    ...
    {sm.map((item)=>{
      return <Box  key={item.href} className='relative  flex center items-center justify-center space-between' 
      sx={{borderRadius:'50%',width:'30px',mx:.35,mt:1,height:'30px'}}>
